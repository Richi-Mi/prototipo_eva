 ...
 */
public class Caso_Seis_Medicamentos extends javax.swing.JFrame {
    ...
    private void jButton_SaveMedicinasActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton_SaveMedicinasActionPerformed
        ...
        {
            Logger.getLogger(Caso_Seis_Medicamentos.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    public static void main(String args[]) {
        ...
        {
            java.util.logging.Logger.getLogger(Caso_Seis_Medicamentos.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
